<?php
/**
 * UniversalPay Payment
 *
 * Contains Checkout Payment Logic
 *
 */
require_once "universalpay/payments.php";
class universalpay
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->title = MODULE_PAYMENT_UNIVERSALPAY_TEXT_TITLE;
        $this->description = MODULE_PAYMENT_UNIVERSALPAY_TEXT_DESCRIPTION;
        $this->sort_order = MODULE_PAYMENT_UNIVERSALPAY_SORT_ORDER;
        $this->merchant_id = MODULE_PAYMENT_UNIVERSALPAY_MERCHANT_ID;
        $this->merchant_passwd = MODULE_PAYMENT_UNIVERSALPAY_MERCHANT_PASSWD;
        $this->merchant_brand_id = MODULE_PAYMENT_UNIVERSALPAY_BRAND_ID;
        $this->enabled = ((MODULE_PAYMENT_UNIVERSALPAY_STATUS == 'True') ? true : false);
        $this->public_title = MODULE_PAYMENT_UNIVERSALPAY_PUBLIC_TITLE;
        ...
        //Gateway urls
        $this->payment_universalpay_test_token_url = 'https://api.test.universalpay.es/token';
        $this->payment_universalpay_test_payments_url = 'https://api.test.universalpay.es/payments';
        $this->payment_universalpay_test_javascript_url = 'https://cashierui.test.universalpay.es/js/api.js';
        $this->payment_universalpay_test_cashier_url = 'https://cashierui.test.universalpay.es/ui/cashier';
        $this->payment_universalpay_token_url = 'https://api.universalpay.es/token';
        $this->payment_universalpay_payments_url = 'https://api.universalpay.es/payments';
        $this->payment_universalpay_javascript_url = 'https://cashierui.universalpay.es/js/api.js';
        $this->payment_universalpay_cashier_url = 'https://cashierui.universalpay.es/ui/cashier';
        
        //clicking on the Confirm Order button will redirect the payment to the below URL to proceed
        if(MODULE_PAYMENT_UNIVERSALPAY_PAYMENT_MODE == 'iframe'){
            $this->form_action_url = tep_href_link('ext/modules/payment/universalpay/iframe.php', '', 'SSL', false);
        }else{
            if(MODULE_PAYMENT_UNIVERSALPAY_SANDBOX_ACTION == 'True'){
                $this->form_action_url = $this->payment_universalpay_test_cashier_url;
            }else{
                $this->form_action_url = $this->payment_universalpay_cashier_url;
            }
        }
    ...
    function check() {
        if (!isset($this->_check)) {
            $check_query = tep_db_query("select configuration_value from " . TABLE_CONFIGURATION . " where configuration_key = 'MODULE_PAYMENT_UNIVERSALPAY_STATUS'");
     ...
     */
    function keys() {
        return array('MODULE_PAYMENT_UNIVERSALPAY_STATUS',
            'MODULE_PAYMENT_UNIVERSALPAY_SANDBOX_ACTION',
            'MODULE_PAYMENT_UNIVERSALPAY_MERCHANT_ID',
            'MODULE_PAYMENT_UNIVERSALPAY_MERCHANT_PASSWD',
            'MODULE_PAYMENT_UNIVERSALPAY_BRAND_ID',
            'MODULE_PAYMENT_UNIVERSALPAY_PAYMENT_MODE',
            'MODULE_PAYMENT_UNIVERSALPAY_PAYMENT_ACTION',
            'MODULE_PAYMENT_UNIVERSALPAY_SORT_ORDER',
            'MODULE_PAYMENT_UNIVERSALPAY_AUTH_ORDER_STATUS_ID',
            'MODULE_PAYMENT_UNIVERSALPAY_SUCCESS_ORDER_STATUS_ID',
            'MODULE_PAYMENT_UNIVERSALPAY_REFUND_ORDER_STATUS_ID',
            'MODULE_PAYMENT_UNIVERSALPAY_VOID_ORDER_STATUS_ID',
            'MODULE_PAYMENT_UNIVERSALPAY_FAIL_ORDER_STATUS_ID',
    ...
    function remove() {
        ...
        tep_db_query("DROP TABLE IF EXISTS `universalpay_transactions`");
        tep_db_query("DROP TABLE IF EXISTS `universalpay_order`");
//         tep_db_query("DELETE FROM " . TABLE_ORDERS_STATUS . " WHERE orders_status_name IN ('On-hold [UniversalPay]','Complete [UniversalPay]','Refunded [UniversalPay]','Voided [UniversalPay]','Failed [UniversalPay]') " );
    }
    /**
    ...
    function install(){
        ...
        tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) 				VALUES ('Enable UniversalPay payment module?', 			'MODULE_PAYMENT_UNIVERSALPAY_STATUS', 'False', 'Do you want to enable UniversalPay payments?', 								'33', '1', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
        tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) 				VALUES ('Test Mode?', 			'MODULE_PAYMENT_UNIVERSALPAY_SANDBOX_ACTION', 'True', 'Do you want to enable test mode?', 								'33', '2', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
        tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) 								VALUES ('Merchant ID',			 					'MODULE_PAYMENT_UNIVERSALPAY_MERCHANT_ID', '', '',				 	'33', '3', now())");
        tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) 								VALUES ('Password', 						        'MODULE_PAYMENT_UNIVERSALPAY_MERCHANT_PASSWD', '', '',		 								'33', '4', now())");
        tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) 								VALUES ('Brand ID', 								'MODULE_PAYMENT_UNIVERSALPAY_BRAND_ID', '', '', 								'33', '5', now())");
        tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) 								VALUES ('Sort order of display', 					'MODULE_PAYMENT_UNIVERSALPAY_SORT_ORDER', '0', '', 						'33', '6', now())");
        $payment_mode = '';
        if(1){
        ...
        tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) 	            VALUES ('Payment mode', 							'MODULE_PAYMENT_UNIVERSALPAY_PAYMENT_MODE', 'hostedPayPage', '', 											'33', '7', 'tep_cfg_select_option(array(\'hostedPayPage\' ".$payment_mode."), ', now())");
        tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) 	            VALUES ('Payment action', 							'MODULE_PAYMENT_UNIVERSALPAY_PAYMENT_ACTION', 'purchase', '', 											'33', '8', 'tep_cfg_select_option(array(\'purchase\', \'auth\'), ', now())");
        tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) VALUES ('Set Auth Status', 'MODULE_PAYMENT_UNIVERSALPAY_AUTH_ORDER_STATUS_ID', '" . $this->auth_status_id . "', '', '33', '9', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
        tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) VALUES ('Set Success Status', 'MODULE_PAYMENT_UNIVERSALPAY_SUCCESS_ORDER_STATUS_ID', '" . $this->complete_status_id . "', '', '33', '10', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
        tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) VALUES ('Set Refunded Status', 'MODULE_PAYMENT_UNIVERSALPAY_REFUND_ORDER_STATUS_ID', '" . $this->refunded_status_id . "', '', '33', '11', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
        tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) VALUES ('Set Voided Status', 'MODULE_PAYMENT_UNIVERSALPAY_VOID_ORDER_STATUS_ID', '" . $this->voided_status_id . "', '', '33', '12', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
        tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) VALUES ('Set Failed Status', 'MODULE_PAYMENT_UNIVERSALPAY_FAIL_ORDER_STATUS_ID', '" . $this->failed_status_id . "', '', '33', '13', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
    ...
    function checktable(){
        $sql = "
            CREATE TABLE IF NOT EXISTS `universalpay_transactions` (
        ...
        tep_db_query($sql);
        $sql_order = "
            CREATE TABLE IF NOT EXISTS `universalpay_order` (
    ...
    function selection()
    {
        global $cart_universalpay_ID;
        
        if (tep_session_is_registered('cart_universalpay_ID')) {
            $order_id = substr($cart_universalpay_ID, strpos($cart_universalpay_ID, '-')+1);
            ...
            if (tep_db_num_rows($check_query) < 1) {
                ...
                tep_session_unregister('cart_universalpay_ID');
            }
        }
...
//         return array('title' => MODULE_PAYMENT_UNIVERSALPAY_PUBLIC_CONFIRFMATION_TITLE);
        global $cartID, $cart_universalpay_ID, $customer_id, $languages_id, $order, $order_total_modules;
        ...
        if (tep_session_is_registered('cartID')) {
            ...
            if (tep_session_is_registered('cart_universalpay_ID')) {
                ...
                if ( ($curr['currency'] != $order->info['currency']) || ($cartID != substr($cart_universalpay_ID, 0, strlen($cartID))) ) {
                    $check_query = tep_db_query('select orders_id from ' . TABLE_ORDERS_STATUS_HISTORY . ' where orders_id = "' . (int)$order_id . '" limit 1');
            ...
            if ($insert_order == true) {
                ...
                $cart_universalpay_ID = $cartID . '-' . $insert_id;
                tep_session_register('cart_universalpay_ID');
            }
        }
    ...
    function process_button() {
        global $order,$customer_id,$languages_id,$cart_universalpay_ID;
        ...
        $post_data['merchantLandingPageUrl'] = html_entity_decode(tep_href_link('ext/modules/payment/universalpay/land.php', tep_session_name().'=' . tep_session_id().'&order_id='.$order_id, 'SSL', false), ENT_QUOTES, 'UTF-8');
        $post_data['merchantNotificationUrl'] = html_entity_decode(tep_href_link('ext/modules/payment/universalpay/callback.php', 'order_id='.$order_id, 'SSL', false), ENT_QUOTES, 'UTF-8');
        ...
        try {
            $this->init_config();
            $payments = (new UniversalpayPayments\Payments())->environmentUrls($this->environment_params);
            if(MODULE_PAYMENT_UNIVERSALPAY_PAYMENT_ACTION == 'auth'){
    ...
    function get_error()
    {
        ...
        if(isset($HTTP_GET_VARS['message'])){
            return array(
                'title' => MODULE_PAYMENT_UNIVERSALPAY_CHECKOUT_ERROR_TITLE,
                'error' => $HTTP_GET_VARS['message']
            );
        }
        if ($HTTP_GET_VARS['code'] == 'T') {
            $errorMessage = MODULE_PAYMENT_UNIVERSALPAY_TEXT_ERROR_MESSAGE_T;
        } elseif ($HTTP_GET_VARS['code'] == 'C') {
            $errorMessage = MODULE_PAYMENT_UNIVERSALPAY_TEXT_ERROR_MESSAGE_C;
        } else {
            $errorMessage = MODULE_PAYMENT_UNIVERSALPAY_TEXT_ERROR_MESSAGE;
        }
        return array(
            'title' => MODULE_PAYMENT_UNIVERSALPAY_CHECKOUT_ERROR_TITLE,
            'error' => $errorMessage
    ...
    private function init_config(){
        ...
        if ($testmode){
            $this->environment_params['tokenURL'] = $this->payment_universalpay_test_token_url;
            $this->environment_params['paymentsURL'] = $this->payment_universalpay_test_payments_url;
            $this->environment_params['baseUrl'] = $this->payment_universalpay_test_cashier_url;
            $this->environment_params['jsApiUrl'] = $this->payment_universalpay_test_javascript_url;
        }else{
            $this->environment_params['tokenURL'] = $this->payment_universalpay_token_url;
            $this->environment_params['paymentsURL'] = $this->payment_universalpay_payments_url;
            $this->environment_params['baseUrl'] = $this->payment_universalpay_cashier_url;
            $this->environment_params['jsApiUrl'] = $this->payment_universalpay_javascript_url;
        }
    }
    ...
    public function get_javascript_url(){
        if(!$this->get_sandbox_environment()){
            return $this->payment_universalpay_javascript_url;
        }else{
            return $this->payment_universalpay_test_javascript_url;
        }
    }
    //to get the gateway's cashier url
    public function get_cashier_url(){
        if(!$this->get_sandbox_environment()){
            return $this->payment_universalpay_cashier_url;
        }else{
            return $this->payment_universalpay_test_cashier_url;
        }
    }
    //to get the payment mode
    public function get_payment_mode(){
        if(MODULE_PAYMENT_UNIVERSALPAY_PAYMENT_MODE == 'hostedPayPage'){
            return 'hostedPayPage';
        }else if(MODULE_PAYMENT_UNIVERSALPAY_PAYMENT_MODE == 'iframe'){
            return 'iframe';
        }else{
            return 'standalone';
        }
...
//                 tep_db_query("UPDATE " . TABLE_ORDERS . " SET `orders_status` = '" . (MODULE_PAYMENT_UNIVERSALPAY_FAIL_ORDER_STATUS_ID > 0 ? (int)MODULE_PAYMENT_UNIVERSALPAY_FAIL_ORDER_STATUS_ID : (int)DEFAULT_ORDERS_STATUS_ID) . "', `last_modified` = now() WHERE `orders_id` = '" . (int)$order_id . "'");
                ...
                if($result->status == 'SET_FOR_CAPTURE' || $result->status == 'CAPTURED'){
                    ...
                    tep_db_query("UPDATE " . TABLE_ORDERS . " SET `orders_status` = '" . (MODULE_PAYMENT_UNIVERSALPAY_SUCCESS_ORDER_STATUS_ID > 0 ? (int)MODULE_PAYMENT_UNIVERSALPAY_SUCCESS_ORDER_STATUS_ID : (int)DEFAULT_ORDERS_STATUS_ID) . "', `last_modified` = now() WHERE `orders_id` = '" . (int)$order_id . "'");
                    $comments = '';
                    $sql_data_array = array('orders_id' => $order_id,
                        'orders_status_id' => (MODULE_PAYMENT_UNIVERSALPAY_SUCCESS_ORDER_STATUS_ID > 0 ? (int)MODULE_PAYMENT_UNIVERSALPAY_SUCCESS_ORDER_STATUS_ID : (int)DEFAULT_ORDERS_STATUS_ID),
                        'date_added' => 'now()',
                    ...
                    tep_db_perform('universalpay_order', $gateway_order_array);
                    $insert_id = tep_db_insert_id();
                    $this->logging('insert_id:'.$insert_id.' gateway_order_array: '.json_encode($gateway_order_array));
                    $gateway_transaction_array = array();
                    $gateway_transaction_array['universalpay_order_id'] = $insert_id;
                    $gateway_transaction_array['created'] = 'now()';
                    $gateway_transaction_array['type'] = 'payment';
                    $gateway_transaction_array['amount'] = $amount;
                    tep_db_perform('universalpay_transactions', $gateway_transaction_array);
                    
                    $this->success_process($order_id,$merchant_tx_id);
                    tep_redirect(tep_href_link(FILENAME_CHECKOUT_SUCCESS, '', 'SSL'));
                }else if($result->status == 'NOT_SET_FOR_CAPTURE'){
                    // AUTH was successful
                    tep_db_query("UPDATE " . TABLE_ORDERS . " SET `orders_status` = '" . (MODULE_PAYMENT_UNIVERSALPAY_AUTH_ORDER_STATUS_ID > 0 ? (int)MODULE_PAYMENT_UNIVERSALPAY_AUTH_ORDER_STATUS_ID : (int)DEFAULT_ORDERS_STATUS_ID) . "', `last_modified` = now() WHERE `orders_id` = '" . (int)$order_id . "'");
                    $comments = '';
                    $sql_data_array = array('orders_id' => $order_id,
                        'orders_status_id' => (MODULE_PAYMENT_UNIVERSALPAY_AUTH_ORDER_STATUS_ID > 0 ? (int)MODULE_PAYMENT_UNIVERSALPAY_AUTH_ORDER_STATUS_ID : (int)DEFAULT_ORDERS_STATUS_ID),
                        'date_added' => 'now()',
                        'customer_notified' => (SEND_EMAILS == 'true') ? '1' : '0',
                        'comments' => $comments);
                    tep_db_perform(TABLE_ORDERS_STATUS_HISTORY, $sql_data_array);                        
                    ...
                    if($result->status == "STARTED" || $result->status == "WAITING_RESPONSE" || $result->status == "INCOMPLETE"){
                        ...
                        $fail_status_query = tep_db_query("SELECT 1 FROM " . TABLE_ORDERS . " WHERE `orders_status`= '".MODULE_PAYMENT_UNIVERSALPAY_FAIL_ORDER_STATUS_ID."' AND `orders_id` = '" . (int)$order_id . "'");
                        ...
                        if (tep_db_num_rows($fail_status_query) < 1) {
                            ...
                            tep_db_query("UPDATE " . TABLE_ORDERS . " SET `orders_status` = '" . (MODULE_PAYMENT_UNIVERSALPAY_FAIL_ORDER_STATUS_ID > 0 ? (int)MODULE_PAYMENT_UNIVERSALPAY_FAIL_ORDER_STATUS_ID : (int)DEFAULT_ORDERS_STATUS_ID) . "', `last_modified` = now() WHERE `orders_id` = '" . (int)$order_id . "'");
                            $sql_data_array = array('orders_id' => $order_id,
                                'orders_status_id' => (MODULE_PAYMENT_UNIVERSALPAY_FAIL_ORDER_STATUS_ID > 0 ? (int)MODULE_PAYMENT_UNIVERSALPAY_FAIL_ORDER_STATUS_ID : (int)DEFAULT_ORDERS_STATUS_ID),
                                'date_added' => 'now()',
                                'customer_notified' => (SEND_EMAILS == 'true') ? '1' : '0',
                                'comments' => '');
                            tep_db_perform(TABLE_ORDERS_STATUS_HISTORY, $sql_data_array);
    ...
    {
        global $customer_id, $order, $order_totals, $languages_id, $payment, $currencies, $cart, $cart_universalpay_ID;
...
//                     }
    ...
    function insert_statuses(){
        //Auth status
        $check_query = tep_db_query("SELECT orders_status_id FROM " . TABLE_ORDERS_STATUS . " WHERE orders_status_name = 'On-hold [UniversalPay]' limit 1");
        if (tep_db_num_rows($check_query) < 1) {
            ...
            for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
                tep_db_query("INSERT INTO " . TABLE_ORDERS_STATUS . " (orders_status_id, language_id, orders_status_name) VALUES ('" . $this->auth_status_id . "', '" . $languages[$i]['id'] . "', 'On-hold [UniversalPay]')");
            }
        ...
        //Purchased status
        $check_query = tep_db_query("SELECT orders_status_id FROM " . TABLE_ORDERS_STATUS . " WHERE orders_status_name = 'Complete [UniversalPay]' limit 1");
        if (tep_db_num_rows($check_query) < 1) {
            $status_query = tep_db_query("SELECT max(orders_status_id) as status_id FROM " . TABLE_ORDERS_STATUS);
            $status = tep_db_fetch_array($status_query);
            ...
            for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
                tep_db_query("INSERT INTO " . TABLE_ORDERS_STATUS . " (orders_status_id, language_id, orders_status_name) VALUES ('" . $this->complete_status_id . "', '" . $languages[$i]['id'] . "', 'Complete [UniversalPay]')");
            }
        ...
        //Refunded status
        $check_query = tep_db_query("SELECT orders_status_id FROM " . TABLE_ORDERS_STATUS . " WHERE orders_status_name = 'Refunded [UniversalPay]' limit 1");
        if (tep_db_num_rows($check_query) < 1) {
            $status_query = tep_db_query("SELECT max(orders_status_id) as status_id FROM " . TABLE_ORDERS_STATUS);
            $status = tep_db_fetch_array($status_query);
            ...
            for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
                tep_db_query("INSERT INTO " . TABLE_ORDERS_STATUS . " (orders_status_id, language_id, orders_status_name) VALUES ('" . $this->refunded_status_id . "', '" . $languages[$i]['id'] . "', 'Refunded [UniversalPay]')");
            }
        ...
        //Voided status
        $check_query = tep_db_query("SELECT orders_status_id FROM " . TABLE_ORDERS_STATUS . " WHERE orders_status_name = 'Voided [UniversalPay]' limit 1");
        if (tep_db_num_rows($check_query) < 1) {
            $status_query = tep_db_query("SELECT max(orders_status_id) as status_id FROM " . TABLE_ORDERS_STATUS);
            $status = tep_db_fetch_array($status_query);
            ...
            for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
                tep_db_query("INSERT INTO " . TABLE_ORDERS_STATUS . " (orders_status_id, language_id, orders_status_name) VALUES ('" . $this->voided_status_id . "', '" . $languages[$i]['id'] . "', 'Voided [UniversalPay]')");
            }
        ...
        //Failed status
        $check_query = tep_db_query("SELECT orders_status_id FROM " . TABLE_ORDERS_STATUS . " WHERE orders_status_name = 'Failed [UniversalPay]' limit 1");
        if (tep_db_num_rows($check_query) < 1) {
            $status_query = tep_db_query("SELECT max(orders_status_id) as status_id FROM " . TABLE_ORDERS_STATUS);
            $status = tep_db_fetch_array($status_query);
            ...
            for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
                tep_db_query("INSERT INTO " . TABLE_ORDERS_STATUS . " (orders_status_id, language_id, orders_status_name) VALUES ('" . $this->failed_status_id . "', '" . $languages[$i]['id'] . "', 'Failed [UniversalPay]')");
            }
    ...
    function checkTransaction($merchant_tx_id=0){
        $transaction = tep_db_query("SELECT 1 FROM `universalpay_order` WHERE `merchant_tx_id`='" . $merchant_tx_id . "'");
    ...
    protected function doCheckAndPatchOrdersCoreTemplateFile($shouldOnlyCheckIfPatched = false)
    {
        ...
        "require_once \$universalpayOrderTransactionsPanelFile;";
        
        $orderTransactionsPanelAutoLoadIncludeBlock =
        "\$universalpayOrderTransactionsPanelFile = DIR_FS_ADMIN . \"ext/modules/payment/universalpay/order_transactions_panel.php\";
  if (file_exists(\$universalpayOrderTransactionsPanelFile)) {
      {$orderTransactionsPanelAutoLoadSearchBlock}
  }
  ";
    ...
    public function capture($merchant_tx_id, $capture_amount,$order_id,$universalpay_order_id) {
        try {
            $this->init_config();
            $payments = (new UniversalpayPayments\Payments())->environmentUrls($this->environment_params);
            ...
            if(!isset($result->result) || $result->result != 'success'){
                ...
                $gateway_transaction_array = array();
                $gateway_transaction_array['universalpay_order_id'] = $universalpay_order_id;
                $gateway_transaction_array['created'] = 'now()';
                $gateway_transaction_array['type'] = 'payment';
                $gateway_transaction_array['amount'] = $capture_amount;
                tep_db_perform('universalpay_transactions', $gateway_transaction_array);
                tep_db_query("UPDATE `universalpay_order` SET `capture_status` = '1' WHERE `order_id` = '" . $order_id . "'");
                tep_db_query("UPDATE " . TABLE_ORDERS . " SET `orders_status` = '" . (MODULE_PAYMENT_UNIVERSALPAY_SUCCESS_ORDER_STATUS_ID > 0 ? (int)MODULE_PAYMENT_UNIVERSALPAY_SUCCESS_ORDER_STATUS_ID : (int)DEFAULT_ORDERS_STATUS_ID) . "', `last_modified` = now() WHERE `orders_id` = '" . (int)$order_id . "'");
                return true;
            }
        } catch (Exception $e) {
    ...
    public function void($merchant_tx_id,$void_amount,$order_id,$universalpay_order_id) {
        try {
            $this->init_config();
            $payments = (new UniversalpayPayments\Payments())->environmentUrls($this->environment_params);
            $void = $payments->void();
            ...
            if(!isset($result->result) || $result->result != 'success'){
                ...
                tep_db_perform('universalpay_transactions', $gateway_transaction_array);
                tep_db_query("UPDATE `universalpay_order` SET `void_status` = '1' WHERE `order_id` = '" . $order_id . "'");
                tep_db_query("UPDATE " . TABLE_ORDERS . " SET `orders_status` = '" . (MODULE_PAYMENT_UNIVERSALPAY_VOID_ORDER_STATUS_ID > 0 ? (int)MODULE_PAYMENT_UNIVERSALPAY_VOID_ORDER_STATUS_ID : (int)DEFAULT_ORDERS_STATUS_ID) . "', `last_modified` = now() WHERE `orders_id` = '" . (int)$order_id . "'");
                return true;
            }
        } catch (Exception $e) {
    ...
    public function refund($merchant_tx_id, $total, $refund_amount,$order_id,$universalpay_order_id) {
//         return true;
        try {
            $this->init_config();
            $payments = (new UniversalpayPayments\Payments())->environmentUrls($this->environment_params);
            ...
            if(!isset($result->result) || $result->result != 'success'){
                ...
                $query = tep_db_query("SELECT SUM(`amount`) AS `total` FROM `universalpay_transactions` WHERE `universalpay_order_id` = '" . (int)$universalpay_order_id . "' AND `type` = 'refund'");
                ...
                if($total == $total_refunded){
                    tep_db_query("UPDATE `universalpay_order` SET `refund_status` = '1' WHERE `order_id` = '" . $order_id . "'");
                    tep_db_query("UPDATE " . TABLE_ORDERS . " SET `orders_status` = '" . (MODULE_PAYMENT_UNIVERSALPAY_REFUND_ORDER_STATUS_ID > 0 ? (int)MODULE_PAYMENT_UNIVERSALPAY_REFUND_ORDER_STATUS_ID : (int)DEFAULT_ORDERS_STATUS_ID) . "', `last_modified` = now() WHERE `orders_id` = '" . (int)$order_id . "'");
                }
