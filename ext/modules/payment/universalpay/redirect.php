...
chdir('../../../../');
  ...
  require(DIR_WS_INCLUDES . 'modules/payment/universalpay.php');
  $payment = new universalpay();
  if($payment->get_sandbox_environment()){
      $cashier_url = $payment->payment_universalpay_test_cashier_url;
  }else{
      $cashier_url = $payment->payment_universalpay_cashier_url;
  }
  $params = array();
